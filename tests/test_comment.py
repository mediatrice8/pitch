...
#     '''
#     def setUp(self):
#         self.user_James = User(username = 'media',password = 'iris', email = 'media@gmail.com)
#         self.new_comment = Comment(pitch_id=12345,pitch_title='Review for movies',image_path="https://image.tmdb.org/t/p/w500/jdjdjdjn",movie_review='This movie is the best thing since sliced bread',user = self.user_Media ) 
...
#         self.assertEquals(self.new_comment.user,self.user_Media) 
